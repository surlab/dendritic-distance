...
class Spine():
    ...
    #<<<<<<<<<<<<<<<<<<
        ...
        self.area_of_roi = 0 #this seems nontrivial and might need a
...
def dist_between_2_spines(Spine1, Spine2):
    if Spine1.parent_dendritic_segment == Spine2.parent_dendritic_segment:
        ...
        spine1_to_first_branch_dist = distance_along_curve(end_dist_idx, Spine1.spine_neck_t, Spine1.parent_dendritic_segment.coords)
            ...
            for child_dendrite in branch_point.child_dendrites:
                if not(child_dendrite == dendrite_segment):
                    if child_dendrite == Spine2.parent_dendritic_segment:
                        ...
                        dendritic_distance = distance_along_curve(end_dist_idx, Spine2.spine_neck_t, child_dendrite.coords)
                        return dendritic_distance
                    else:
                        #recursion here
